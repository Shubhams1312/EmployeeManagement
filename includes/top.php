    ...
    <div class="page-header-inner "> 
            ...
            <div class="hor-menu   hidden-sm hidden-xs">
                <ul class="nav navbar-nav">
                            ...
                            <div class="menu">
                              ...
                              <div class="item">
                                ...
                                <div class="sub-menu">
                                  ...
                                  <a href="\hr_management\master\de_master.php" class="sub-item">Add Designation</a>
                                  <a href="\hr_management\master\department_master.php" class="sub-item">Add Division</a>
                                  <a href="\hr_management\master\department_master.php" class="sub-item">Add Bank</a>
                                  <a href="\hr_management\master\department_master.php" class="sub-item">Add Grade</a>
                                  <a href="\hr_management\master\department_master.php" class="sub-item">Add Reporting</a>
                                  <a href="\hr_management\master\department_master.php" class="sub-item">Add State</a>
                                  <a href="\hr_management\master\department_master.php" class="sub-item">Add Branch</a>
                                </div>
                              </div> 
                              <div class="item">
                    ...
                    <li class="classic-menu-dropdown " aria-haspopup="true">
                        <a href="./emp_details.php"> Employee details
                            <span class="selected"></span>
                        </a>
                    </li> 
                    <li class="classic-menu-dropdown " aria-haspopup="true">
                        <a href="./uploadfile.php"> Document Upload
                            <span class="selected"></span>
                        </a>
                    </li>
                    <li class="classic-menu-dropdown " aria-haspopup="true">
                        <a href="./pre_emp.php"> Previous Employee
                            <span class="selected"></span>
                        </a>
                    </li>
                    <li class="classic-menu-dropdown " aria-haspopup="true">
                        <a href="./fam_emp.php"> Famliy & Nominee
                            <span class="selected"></span>
                        </a>
                    </li>
